export const Contact = () => {
  return <section id="contact" className="max-w-2xl mx-auto px-6 py-20 flex flex-col items-center text-center gap-6">
    <p className="text-xs font-medium tracking-[2px] text-accent">CONTACT</p>

    <h2 className="text-3xl font-semibold text-text-primary">Let's build something together</h2>
    <a href="mailto:#" className="px-7 py-3 rounded-lg bg-accent text-bg-page text-base font-semibold hover:bg-accent-light hover:scale-103 active:scale-97 transition-all duration-150">Get in touch</a>
